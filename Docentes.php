...
<body>
	...
	<div class="container">
		<form action="" method="post" ectype="multipart/form-data" >
			...
			<label for="Carrera">Materia:</label><br>
			...
			<br>
			<button value="btnRegistrarAlumno" type="submit" name="accion">Registrar </button>
			<button value="btnModificaAlumno" type="submit" name="accion">Modificar </button>
			<button value="btnEliminarAlumno" type="submit" name="accion">Eliminar </button>
